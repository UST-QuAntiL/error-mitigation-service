...
from app.model.mmgen_request import MMGenRequestSchema, MMGenRequest, MMGetRequest, MMGetRequestSchema
...
def retrieve(request):
    ...
    req = MMGetRequest(
        qpu=qpu, cm_gen_method=cm_gen_method, mitigation_method=mitigation_method, qubits=qubits, max_age=max_age,
