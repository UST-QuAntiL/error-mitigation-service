...
def generate_cm(json):
    ...
    method = json.get("cmgenmethod")
    provider = json.get("provider").lower()

    generator = retrieve_generator(method)
    ...
    return store_matrix_file_in_db(cm, qpu, "cm", qubits, method)


def retrieve_cm(req: CMGetRequest):
    return load_matrix_file_from_db(qpu=req.qpu, used_qubits=req.qubits, method=req.method, max_age=req.max_age)




if __name__ == "__main__":
    json = {'cmgenmethod': 'standard', 'qpu': 'ibmq_lima', 'provider': 'IBM', 'shots': 10, 'token': '350a71abf1741a8ad3a59a15f57dd56fa8c9621c27377fd43132c660d6dd47210577697228245e8d531130ed265c2589910bef4d3957580573edfd03c3157b84', 'qubits': [1, 2, 3]}
